...
public class BitManipulation {
    ...
    static void printBinaryInt(String desc , int num){
        System.out.println(desc + " ,int:" + num + " , binary:\n" + Integer.toBinaryString(num));
    }

    static void printBinaryLong(String desc , long num){
        System.out.println(desc + " ,long:" + num + " , binary:\n" + Long.toBinaryString(num));
    }
